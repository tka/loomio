class DiscussionItems::DiscussionDescriptionEdited < DiscussionItem
  ...
  def body
    "<a href='/d/#{@discussion.key}/show_description_history' class='see-description-history' data-method='post' data-remote='true' rel='nofollow'>#{I18n.t(:see_more)}</a>".html_safe
  end
